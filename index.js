...
class Game extends React.Component {
  ...
  handleClick(i,move) {
    ...
    if (calculateWinner(squares) || squares[i]) {
      if(i === 12){
         squares[history.length + 4] = "=";
        if(squares[history.length + 2] == "+"){
             squares[history.length + 5] = squares[history.length + 1] + squares[history.length + 3];
           }
        else if(squares[history.length + 2] == "-"){
             squares[history.length + 5] = squares[history.length + 1] - squares[history.length + 3];
           }
        else if(squares[history.length + 2] == "*"){
             squares[history.length + 5] = squares[history.length + 1] * squares[history.length + 3];
        ...
        squares[history.length + 4] = squares[i];
      }
